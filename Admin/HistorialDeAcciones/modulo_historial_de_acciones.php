...
<body>
    ...
    <div class=" px-4 py-4 bg-white shadow-lg rounded-lg lg:h-max ">
        ...
        <h1 class="text-gray-500 text-lg text-center border-b border-gray-200 mb-5 w-auto ">Historial de Movimientos</h1>
        ...
        <div class="flex lg:flex-row flex-col gap-1">
            ...
            <div class="lg:w-4/5 lg:pl-5 lg:float-right overflow-scroll ">
                ...
                <table id="table" class="display">
                    <thead>
                        <tr>
                            <th class='lg:px-4 lg:py-3 text-sm px-2'>Usuario</th>
