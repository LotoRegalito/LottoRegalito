...
<body class="[ bg-[#197291] h-full ] ">
    ...
    <div class="navbar bg-base-100 z-20">
        ...
        <div class="[ navbar-end hidden  gap-3 ] [ md:flex ] [ lg:flex ] ">
            <a href="../index.html" class="btn btn-primary text-white"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5">
